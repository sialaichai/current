...
class Game {
  constructor() {
    ...
    this.init();
    this.setupEventListeners(); // Now safe: DOM is ready
...
checkDoorCollision() {
  ...
  // ✅ FULLY IMPLEMENTED: Event Listeners
  setupEventListeners() {
    // Start Screen
    ...
    // Keyboard pause (already handled in InputHandler)
  }

  // Joystick not used in this version — safe to omit or stub
  setupJoystick() {
    // Optional: Add virtual joystick for mobile if needed
